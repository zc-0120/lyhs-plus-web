      ...
      {isMobile ? (
        ...
        <>
          <ul className="list-none p-0 ml-auto flex flex-row">
            <li className="m-2 border-b border-transparent hover:border-b-black font-bold">
              <Link href={"/"}>首頁</Link>
            </li>
            <li className="m-2 border-b border-transparent hover:border-b-black font-bold">
              <Link href={"/join-beta"}>加入測試版</Link>
            </li>
          </ul>
        </>
      )}
      <AnimatePresence mode="wait">
        {menuOpen && isMobile && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            className={
              "fixed left-0 bg-gray-100/85 flex-grow w-full h-dvh m-menu p-4 box-border top-0 z-10 backdrop-blur overflow-auto flex flex-col"
            }
          >
