...
export default async function Home() {
  return (
    <main>
      <div
        className="m-4 p-2 mt-0 box-border flex flex-col justify-center items-center overflow-hidden relative"
        style={{ height: `calc(100dvh - 85px)` }}
      >
        <div className="z-10 flex items-center justify-center flex-col">
          <div className="m-5 flex flex-col items-center justify-center gap-2 md:gap-4">
            <h1 className="font-bold text-2xl md:text-3xl">
              林園高中資訊整合平台
            </h1>
            <p className="text-lg md:text-2xl">幫你統整所有資訊，打開新視野</p>
          </div>
          <div className="flex gap-5 items-center">
            <Link
              href={"https://beta.plus.lyhsca.org"}
              target="_blank"
              className="font-medium bg-black shadow text-white p-4 rounded-xl flex gap-2 items-center"
            >
              前往測試版
            ...
            <Link
              href={"/feature"}
              className="bg-white border font-medium border-zinc-300 p-4 rounded-xl  hover:bg-zinc-100 transition-all text-zinc-700"
            >
              瞭解更多
            </Link>
          </div>
          ...
          <div className={"absolute bottom-5 text-gray-400"}>
            ...
            >
              <path
                stroke="currentColor"
                strokeLinecap="round"
                d="m1 1 11.553 5.776a1 1 0 0 0 .894 0L25 1"
              ></path>
            </svg>
          </div>
          */}
          <div className={"absolute bottom-20 right-20 sm:block md:hidden"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
